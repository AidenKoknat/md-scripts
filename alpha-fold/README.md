...
- Download pdb from AlphaFold DB using **[pdb-downloader.sh](./re-download/pdb-downloader.sh)** or Dr Shao's scripts **[shao-scripts](./shao-scripts)**.
  ...
  * Create batch1 csv: python3 **[select-samples.py](./v4-data-download/select-samples.py)** accessions_id.csv [FIRST_BATCH_NAME]
    * Replace [FIRST_BATCH_NAME] with whatever name you would like to give the generated batch
